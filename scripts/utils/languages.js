...
const translations = {
    sk: {
        ...
        openPanel: "Otvoriť panel",
        removePatternTooltip: "Odstrániť",
        ...
        tutorialStep3Intro: 'Po výbere vzorov kliknite na tlačidlo "Generovať sekvenciu". Spustí sa výpočet podobnosti a Markovov rozhodovací proces.',
        tutorialStep4Title: "Parametre MDP",
        tutorialStep4Intro: "Môžete upraviť pokročilé parametre (γ, odmeny, ε) a zapnúť voliteľné funkcie ako IDF, sentiment, referenčný bonus alebo USE.",
        tutorialStep5Title: "Matica podobností",
        tutorialStep5Intro: "Zobrazuje kosínusovú podobnosť medzi vzormi. Čím tmavšia farba, tým vyššia podobnosť. Môžete prepnúť na graf alebo štatistiky.",
        tutorialStep6Title: "Graf podobností",
        tutorialStep6Intro: "Interaktívny graf zobrazuje vzťahy medzi vzormi. Hrubšia čiara = vyššia podobnosť. Kliknutím na uzol zobrazíte podrobnosti.",
        tutorialStep7Title: "Navrhnutá sekvencia",
        tutorialStep7Intro: "Tu sa zobrazí vygenerovaná postupnosť vzorov. Vzory môžete pretiahnuť myšou a zmeniť ich poradie.",
        tutorialStep8Title: "Export výsledkov",
        tutorialStep8Intro: "Sekvenciu môžete exportovať ako TXT, PDF, CSV alebo PNG. Tlačidlo 'Export PRO' vytvorí ZIP archív so všetkými dátami.",
        nextLabel: "Ďalej →",
        prevLabel: "← Späť",
        doneLabel: "Hotovo",
        ...
        clickToSeeWhatsNew: "Kliknite pre zobrazenie noviniek",
        ...
        forcedGoalUsed: "🎯 Používateľom vynútený cieľový vzor:",
        ...
        summaryMatrixSize: "matica",
        summaryStates: "stavov",
        summaryUniqueAction: "unikátna akcia",
        summaryUniqueActions: "unikátne akcie",
        summaryItems: "položiek",
    ...
    en: {
        ...
        tutorialStep3Intro: 'After selecting patterns, click "Generate Sequence". This will start the similarity calculation and Markov Decision Process.',
        tutorialStep4Title: "MDP Parameters",
        tutorialStep4Intro: "You can adjust advanced parameters (γ, rewards, ε) and enable optional features like IDF, sentiment, reference bonus, or USE.",
        tutorialStep5Title: "Similarity Matrix",
        tutorialStep5Intro: "Displays cosine similarity between patterns. Darker color means higher similarity. You can switch to graph or statistics view.",
        tutorialStep6Title: "Similarity Graph",
        tutorialStep6Intro: "Interactive graph showing relationships between patterns. Thicker line = higher similarity. Click a node to see details.",
        tutorialStep7Title: "Suggested Sequence",
        tutorialStep7Intro: "This shows the generated pattern sequence. You can drag patterns with your mouse to change their order.",
        tutorialStep8Title: "Export Results",
        tutorialStep8Intro: "You can export the sequence as TXT, PDF, CSV, or PNG. The 'Export PRO' button creates a ZIP archive with all data.",
        nextLabel: "Next →",
        prevLabel: "← Back",
        doneLabel: "Done",
        ...
        clickToSeeWhatsNew: "Click to see what's new",
        ...
        forcedGoalUsed: "🎯 User-forced goal pattern:",
        ...
        summaryMatrixSize: "matrix",
        summaryStates: "states",
        summaryUniqueAction: "unique action",
        summaryUniqueActions: "unique actions",
        summaryItems: "items",
...
function updateTextContent() {
    ...
    document.querySelectorAll('.selected-pattern-remove').forEach(btn => {
        btn.title = t.removePatternTooltip || 'Odstrániť';
    });
